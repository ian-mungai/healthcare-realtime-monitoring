...
def build_observation(
    ...
    return {
        ...
        "extension": [
            {
                "url": "https://example.org/fhir/StructureDefinition/source_record_id",
                "valueString": source_record_id,
            },
            {
                "url": "https://example.org/fhir/StructureDefinition/source_offset_seconds",
                "valueInteger": source_offset_seconds,
            },
        ],
    }
    ...
    return {
        ...
        "code": {
            "coding": [
                {
                    "system": LOINC_SYSTEM,
                    "code": BLOOD_PRESSURE["loinc_code"],
                    "display": BLOOD_PRESSURE["display"],
                }
            ],
        ...
        "component": [
            {
                "code": {
                    "coding": [
                        {
                            "system": LOINC_SYSTEM,
                            "code": SYSTOLIC_BP["loinc_code"],
                            "display": SYSTOLIC_BP["display"],
                        }
                    ]
                },
                "valueQuantity": {
            ...
            },
            {
                "code": {
                    "coding": [
                        {
                            "system": LOINC_SYSTEM,
                            "code": DIASTOLIC_BP["loinc_code"],
                            "display": DIASTOLIC_BP["display"],
                        }
                    ]
                },
                "valueQuantity": {
        ...
        "extension": [
            {
                "url": "https://example.org/fhir/StructureDefinition/source_record_id",
                "valueString": reading.source_observation_id or "synthea_bp",
            },
            {
                "url": "https://example.org/fhir/StructureDefinition/source_offset_seconds",
                "valueInteger": source_offset_seconds,
...
def build_observations_from_reading(
    reading: VitalReading, patient_id: str, encounter_id: str, simulation_start: datetime
) -> list[dict[str, Any]]:

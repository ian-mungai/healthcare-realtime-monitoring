...
def build_observation(*,
    ...
    value: float,
    unit: str,
    ucum_code: str, source_record_id: str, source_offset_seconds: int,) -> dict[str, Any]:
        ...
        "extension": [
            {
                "url": (
                    ...
                    "StructureDefinition/source-record-id"
                ),
            ...
            },
            {
                "url": (
                    "https://example.org/fhir/"
                    "StructureDefinition/source-offset-seconds"
                ),
...
def build_observations_from_reading(
    ...
    """
    Convert one BIDMC VitalReading into zero to three
    FHIR Observation resources.

    Missing measurements are skipped rather than invented.
    """
    effective_datetime = build_effective_datetime(
        simulation_start,
    ...
    heart_rate = normalize_measurement(
        reading.heart_rate
    )
    ...
    respiratory_rate = normalize_measurement(

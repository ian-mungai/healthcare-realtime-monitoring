...
def get_effective_datetime(observation: dict) -> str:
...
def build_observation_identifier(patient_id: str, source_record_id: str, offset_seconds: int, observation_code: str, effective_datetime: str) -> str:
    raw_identifier = f"{patient_id}:{source_record_id}:{offset_seconds}:{observation_code}:{effective_datetime}"
...
def add_observation_identifier(observation: dict, source_record_id: str, offset_seconds: int) -> dict:
    ...
    effective_datetime = get_effective_datetime(observation)

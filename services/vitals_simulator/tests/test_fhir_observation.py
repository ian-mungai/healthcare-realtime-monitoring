...
def test_build_effective_datetime_requires_timezone():
    start = datetime(2026, 8, 20, 12, 0, 0)

    with pytest.raises(ValueError, match="timezone-aware"):
        build_effective_datetime(start, 5)


def test_build_three_observations():
    reading = VitalReading(source_record_id="bidmc01n", offset_seconds=2, heart_rate=94.0, respiratory_rate=(24.999969557786706), spo2=97.0)
...
def test_patient_reference():
    reading = VitalReading(source_record_id="bidmc01n", offset_seconds=0, heart_rate=94.0, respiratory_rate=25.0, spo2=97.0)
...
def test_effective_datetime_uses_bidmc_offset():
    reading = VitalReading(source_record_id="bidmc01n", offset_seconds=5, heart_rate=94.0, respiratory_rate=25.0, spo2=97.0)
...
def test_missing_measurement_is_skipped():
    reading = VitalReading(source_record_id="bidmc01n", offset_seconds=0, heart_rate=94.0, respiratory_rate=None, spo2=97.0)
...
def test_heart_rate_quantity():
    reading = VitalReading(source_record_id="bidmc01n", offset_seconds=0, heart_rate=94.0, respiratory_rate=None, spo2=None)

...
os.environ["KINESIS_STREAM_ARN"] = "arn:aws:kinesis:us-east-1:<aws-account-id>:stream/healthcare_realtime_vitals"
...
def test_parse_failure_message_rejects_unexpected_stream() -> None:
    record = build_sqs_record(stream_arn="arn:aws:kinesis:us-east-1:<aws-account-id>:stream/unexpected")

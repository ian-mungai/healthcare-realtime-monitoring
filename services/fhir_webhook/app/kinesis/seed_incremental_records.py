...
def build_incremental_observations() -> list[dict]:
    ...
    return [
        build_observation("step_13_hr_001", "8867-4", "Heart rate", 79.0, "beats/minute", simulation_start),
        build_observation("step_13_rr_001", "9279-1", "Respiratory rate", 17.0, "breaths/minute", simulation_start + timedelta(seconds=1)),
        build_observation("step_13_spo2_001", "2708-6", "Oxygen saturation", 98.0, "%", simulation_start + timedelta(seconds=2)),
        build_observation("step_13_hr_invalid_001", "8867-4", "Heart rate", 500.0, "beats/minute", simulation_start + timedelta(seconds=3)),
    ]
